...
contract EmergencyUpgradeBoard is EIP712 {
  ...
  /// @notice Executes an emergency protocol upgrade approved by the Security Council and ZK Foundation.
  ...
  /// @param _securityCouncilSignatures Encoded signers & signatures from the Security Council multisig, required to
  /// authorize the emergency upgrade.
